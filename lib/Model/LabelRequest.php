 ...
 */
class LabelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LabelRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('hwb', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $responsible_station responsible_station
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getHwb()
    {
        return $this->container['hwb'];
    }

    /**
     * Sets hwb
     *
     * @param string|null $hwb hwb
     *
     * @return self
     */
    public function setHwb($hwb)
    {
        if (is_null($hwb)) {
            throw new \InvalidArgumentException('non-nullable hwb cannot be null');
        }
        $this->container['hwb'] = $hwb;
